...
<link>//{{$gimme->publication->site}}</link>
...
<atom:link href="{{ $gimme->publication->site }}/en/static/rss" rel="self" type="application/rss+xml" />
...
<link>//{{$gimme->publication->site}}/{{ $gimme->language->code }}/{{$gimme->issue->url_name}}/{{$gimme->section->url_name}}/{{$gimme->article->number}}</link>
<description>
...
<category domain="//{{$gimme->publication->site}}/{{ $gimme->language->code }}/{{ $gimme->issue->url_name }}/{{$gimme->section->url_name}}">{{$gimme->section->name}}</category>
...
<guid isPermaLink="true">//{{$gimme->publication->site}}/{{ $gimme->language->code }}/{{ $gimme->issue->url_name }}/{{$gimme->section->url_name}}/{{$gimme->article->number}}</guid>
</item>
{{/list_articles}}
</channel>
</rss>